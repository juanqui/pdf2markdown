...
from ..api import PDFConverter, ConfigBuilder, Config
...
def main(
    ...
    try:
        ...
        display_model = llm_config.get('model', 'Not configured') if llm_config else 'Not configured'
        ...
        if page_limit:
            ...
            console.print(f"[yellow]Note: Page limit is not yet implemented in library mode[/yellow]")
        
        # Run synchronously for CLI
        markdown_content = converter.convert_sync(
            input_file, 
            output_path, 
